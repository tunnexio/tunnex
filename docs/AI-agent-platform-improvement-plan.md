...
| **F17 — Final CSS and UX polish** |  |  | Complete responsive layouts, accessibility, terminology, loading/empty/error states, spacing, and visual consistency after behavior is stable. | 🟨 Decision paper complete; implementation not started |
