...
**ACTIVE DRAFT (2026-09-09): AI Gateway, group access and workload identities — PR #67, content tip `eb0fa476b07dd42482cab96da3dfed94bf5b5f43` (pre-merge), remote branch `story/S-AI-workload-identity`; companion tunnex-web PR #48 at `4dfb7f41484fb8f1fa41017dde0fe5126a604a49`. Main NAT PR #66 (`219d422b`) integrated in an isolated publication checkout; main owns migrations139–141, unpublished AI now142–154 and156. Core conflicts resolved; both API builds, full CLI, web1504/typecheck/build, generation, schema141→156, affected open suites and enterprise AI rerun pass. All other enterprise packages passed the full integration run; probe race20, toolchain refusal contracts4 and CI classifier/gate contracts44 pass. Website221/typecheck/build/lint/format and exact-head remote checks/preview pass. Final core remote CI remains pending. See `docs/S-AI-publication-validation.md` and workload review for held W7/production/MCP qualification. Original local preview database and unrelated work preserved; no merge or production deployment. NEXT: review both drafts and assess CI at the latest remote head. Earlier checkpoints below are historical.**
