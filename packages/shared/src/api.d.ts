...
export interface components {
    schemas: {
        ...
        /** @enum {string} */
        AlertEventKey: "agent.offline" | "agent.denial_spike" | "agent.access_expiring" | "agent.rotation_failed" | "agent.configuration_drift" | "gateway.offline" | "gateway.policy_degraded" | "site.link_down" | "ipsec.tunnel_down" | "ipsec.connection_down" | "ipsec.status_unavailable" | "device.offline" | "device.posture_blocked" | "kubernetes.connector_degraded" | "kubernetes.inventory_stale" | "kubernetes.service_unavailable";
        /** @enum {string} */
        AlertOccurrenceState: "firing" | "resolved";
        /** @enum {string} */
        AlertResourceType: "agent" | "gateway" | "site" | "device" | "kubernetes_cluster" | "kubernetes_service" | "ipsec_connection";
        AlertOccurrence: {
            /** Format: uuid */
            id: string;
        ...
        Node: {
            ...
            enrolled_at: string;
            /**
             * @description The immutable enrollment declaration. gateway is eligible to carry a Site LAN; agent is an AI Agent identity and cannot be bound to a Site. NULL is a legacy undetermined declaration and is not eligible for new Site binding.
             * @enum {string|null}
             */
            enrolled_kind?: "gateway" | "agent" | null;
            /** Format: date-time */
            last_seen_at?: string;
        ...
        AgentBootstrapRelease: {
             ...
             */
            manifest_url: string;
            /** @description Public verifier key identifier. */
