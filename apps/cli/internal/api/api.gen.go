...
type ClientInterface interface {
	...
	// UpdateGatewayEndpointWithBody request with any body
	UpdateGatewayEndpointWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateGatewayEndpoint(ctx context.Context, body UpdateGatewayEndpointJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// UpdateDeviceMode request
	UpdateDeviceMode(ctx context.Context, orgId openapi_types.UUID, deviceId openapi_types.UUID, params *UpdateDeviceModeParams, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// SetK8sClusterConnectorWithBody request with any body
...
func (c *Client) UpdateGatewayEndpointWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateGatewayEndpointRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateGatewayEndpoint(ctx context.Context, body UpdateGatewayEndpointJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateGatewayEndpointRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateDeviceMode(ctx context.Context, orgId openapi_types.UUID, deviceId openapi_types.UUID, params *UpdateDeviceModeParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateDeviceModeRequest(c.Server, orgId, deviceId, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) SetK8sClusterConnectorWithBody(ctx context.Context, orgId openapi_types.UUID, clusterId openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewSetK8sClusterConnectorRequestWithBody(c.Server, orgId, clusterId, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewGetGatewayEndpointRequest(server string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/api/v1/admin/gateway-endpoint")
	if operationPath[0] == '/' {
...
// NewUpdateGatewayEndpointRequest calls the generic UpdateGatewayEndpoint builder with application/json body
func NewUpdateGatewayEndpointRequest(server string, body UpdateGatewayEndpointJSONRequestBody) (*http.Request, error) {
	...
	return NewUpdateGatewayEndpointRequestWithBody(server, "application/json", bodyReader)
}

// NewUpdateGatewayEndpointRequestWithBody generates requests for UpdateGatewayEndpoint with any type of body
func NewUpdateGatewayEndpointRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewUpdateDeviceModeRequest generates requests for UpdateDeviceMode
func NewUpdateDeviceModeRequest(server string, orgId openapi_types.UUID, deviceId openapi_types.UUID, params *UpdateDeviceModeParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v1/organizations/%s/devices/%s/mode", pathParam0, pathParam1)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
	...
	if params != nil {
		...
		if params.FullTunnel != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "full_tunnel", runtime.ParamLocationQuery, *params.FullTunnel); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
// NewSetK8sClusterConnectorRequest calls the generic SetK8sClusterConnector builder with application/json body
func NewSetK8sClusterConnectorRequest(server string, orgId openapi_types.UUID, clusterId openapi_types.UUID, body SetK8sClusterConnectorJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewSetK8sClusterConnectorRequestWithBody(server, orgId, clusterId, "application/json", bodyReader)
}

// NewSetK8sClusterConnectorRequestWithBody generates requests for SetK8sClusterConnector with any type of body
func NewSetK8sClusterConnectorRequestWithBody(server string, orgId openapi_types.UUID, clusterId openapi_types.UUID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v1/organizations/%s/k8s/clusters/%s/connector", pathParam0, pathParam1)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// UpdateGatewayEndpointWithBodyWithResponse request with any body
	UpdateGatewayEndpointWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateGatewayEndpointResponse, error)

	UpdateGatewayEndpointWithResponse(ctx context.Context, body UpdateGatewayEndpointJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateGatewayEndpointResponse, error)
	...
	// UpdateDeviceModeWithResponse request
	UpdateDeviceModeWithResponse(ctx context.Context, orgId openapi_types.UUID, deviceId openapi_types.UUID, params *UpdateDeviceModeParams, reqEditors ...RequestEditorFn) (*UpdateDeviceModeResponse, error)
	...
	// SetK8sClusterConnectorWithBodyWithResponse request with any body
...
type GetGatewayEndpointResponse struct {
	...
	JSON200      *GatewayEndpoint
	JSONDefault  *Error
}

// Status returns HTTPResponse.Status
func (r GetGatewayEndpointResponse) Status() string {
...
func (r GetGatewayEndpointResponse) StatusCode() int {
	if r.HTTPResponse != nil {
...
type UpdateGatewayEndpointResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *GatewayEndpoint
	JSONDefault  *Error
...
// Status returns HTTPResponse.Status
func (r UpdateGatewayEndpointResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r UpdateGatewayEndpointResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type UpdateDeviceModeResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *UpdateDeviceModeResult
	JSONDefault  *Error
}

// Status returns HTTPResponse.Status
func (r UpdateDeviceModeResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r UpdateDeviceModeResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type SetK8sClusterConnectorResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSONDefault  *Error
}
...
// Status returns HTTPResponse.Status
func (r SetK8sClusterConnectorResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r SetK8sClusterConnectorResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
func (c *ClientWithResponses) GetGatewayEndpointWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetGatewayEndpointResponse, error) {
	...
	return ParseGetGatewayEndpointResponse(rsp)
}

// UpdateGatewayEndpointWithBodyWithResponse request with arbitrary body returning *UpdateGatewayEndpointResponse
func (c *ClientWithResponses) UpdateGatewayEndpointWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateGatewayEndpointResponse, error) {
	rsp, err := c.UpdateGatewayEndpointWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateGatewayEndpointResponse(rsp)
}

func (c *ClientWithResponses) UpdateGatewayEndpointWithResponse(ctx context.Context, body UpdateGatewayEndpointJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateGatewayEndpointResponse, error) {
	rsp, err := c.UpdateGatewayEndpoint(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateGatewayEndpointResponse(rsp)
...
// UpdateDeviceModeWithResponse request returning *UpdateDeviceModeResponse
func (c *ClientWithResponses) UpdateDeviceModeWithResponse(ctx context.Context, orgId openapi_types.UUID, deviceId openapi_types.UUID, params *UpdateDeviceModeParams, reqEditors ...RequestEditorFn) (*UpdateDeviceModeResponse, error) {
	rsp, err := c.UpdateDeviceMode(ctx, orgId, deviceId, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateDeviceModeResponse(rsp)
}
...
// SetK8sClusterConnectorWithBodyWithResponse request with arbitrary body returning *SetK8sClusterConnectorResponse
func (c *ClientWithResponses) SetK8sClusterConnectorWithBodyWithResponse(ctx context.Context, orgId openapi_types.UUID, clusterId openapi_types.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SetK8sClusterConnectorResponse, error) {
	rsp, err := c.SetK8sClusterConnectorWithBody(ctx, orgId, clusterId, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) SetK8sClusterConnectorWithResponse(ctx context.Context, orgId openapi_types.UUID, clusterId openapi_types.UUID, body SetK8sClusterConnectorJSONRequestBody, reqEditors ...RequestEditorFn) (*SetK8sClusterConnectorResponse, error) {
	rsp, err := c.SetK8sClusterConnector(ctx, orgId, clusterId, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseSetK8sClusterConnectorResponse(rsp)
...
func ParseGetGatewayEndpointResponse(rsp *http.Response) (*GetGatewayEndpointResponse, error) {
	...
	response := &GetGatewayEndpointResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseUpdateGatewayEndpointResponse parses an HTTP response from a UpdateGatewayEndpointWithResponse call
func ParseUpdateGatewayEndpointResponse(rsp *http.Response) (*UpdateGatewayEndpointResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &UpdateGatewayEndpointResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseUpdateDeviceModeResponse parses an HTTP response from a UpdateDeviceModeWithResponse call
func ParseUpdateDeviceModeResponse(rsp *http.Response) (*UpdateDeviceModeResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &UpdateDeviceModeResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest UpdateDeviceModeResult
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
// ParseSetK8sClusterConnectorResponse parses an HTTP response from a SetK8sClusterConnectorWithResponse call
func ParseSetK8sClusterConnectorResponse(rsp *http.Response) (*SetK8sClusterConnectorResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &SetK8sClusterConnectorResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
