...
func main() {
	...
	go reportKeyLoop(ctx, client, wgPub, endpointSource, endpointKick, &egressNAT, &egressIPv6, egressMgr, &siteLinkStale, &siteSubnetUnreachable, &ovpnHealth, &keyReported, reportEvery, logger)
