...
// This test pins the serialized v2 contract that apps/node mirrors without
...
func TestGatewayDNSRPCV2WireShape(t *testing.T) {
	request := GatewayDNSRequest{
		...
		ResolverConfigID: uuid.MustParse("66666666-6666-6666-6666-666666666666"), ResolverConfigVersion: 3,
		ResolverProfileID: uuid.MustParse("77777777-7777-7777-7777-777777777777"), ResolverMatchSuffix: "internal",
		ResolverEndpoints: []ResolverEndpoint{{Address: netip.MustParseAddr("10.53.0.53"), Port: 53, Transport: "udp"}},
	...
	wantKeys := []string{"version", "request_id", "org_id", "resource_id", "site_id", "gateway_id", "resolver_config_id", "resolver_config_version", "resolver_profile_id", "resolver_match_suffix", "resolver_endpoints", "hostname", "record_types", "deadline"}
	...
	wantKeys = []string{"version", "request_id", "org_id", "resource_id", "site_id", "gateway_id", "resolver_config_id", "resolver_config_version", "resolver_profile_id", "resolver_match_suffix", "hostname", "record_types", "observed_at", "status", "records"}
	if len(got) != len(wantKeys) {
