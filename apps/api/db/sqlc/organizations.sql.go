...
SELECT id, name, slug, created_at, updated_at, deleted_at, max_devices_per_user, pool_cidr, zero_trust_mode, device_approval, flow_seq, ovpn_enabled, max_agent_identities, managed_agent_runtime_enabled, agent_policy_templates_enabled, agent_jit_access_enabled, alerting_enabled FROM organizations
...
func (q *Queries) ListAlertingEnabledOrganizations(ctx context.Context) ([]uuid.UUID, error) {
	rows, err := q.db.Query(ctx, listAlertingEnabledOrganizations)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const setOrganizationAgentJITAccessEnabled = `-- name: SetOrganizationAgentJITAccessEnabled :one
...
func (q *Queries) SetOrganizationAgentJITAccessEnabled(ctx context.Context, arg SetOrganizationAgentJITAccessEnabledParams) (Organization, error) {
	row := q.db.QueryRow(ctx, setOrganizationAgentJITAccessEnabled, arg.ID, arg.AgentJitAccessEnabled)
	var i Organization
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) SetOrganizationAgentRuntimeEnabled(ctx context.Context, arg SetOrganizationAgentRuntimeEnabledParams) (Organization, error) {
	row := q.db.QueryRow(ctx, setOrganizationAgentRuntimeEnabled, arg.ID, arg.ManagedAgentRuntimeEnabled)
	var i Organization
	err := row.Scan(
		&i.ID,
		&i.Name,
...
const setOrganizationAlertingEnabled = `-- name: SetOrganizationAlertingEnabled :one
UPDATE organizations
...
func (q *Queries) SetOrganizationAlertingEnabled(ctx context.Context, arg SetOrganizationAlertingEnabledParams) (Organization, error) {
	row := q.db.QueryRow(ctx, setOrganizationAlertingEnabled, arg.ID, arg.AlertingEnabled)
	var i Organization
	err := row.Scan(
		&i.ID,
		&i.Name,
...
const updateOrganizationAgentQuota = `-- name: UpdateOrganizationAgentQuota :one
UPDATE organizations
...
func (q *Queries) UpdateOrganizationAgentQuota(ctx context.Context, arg UpdateOrganizationAgentQuotaParams) (Organization, error) {
	row := q.db.QueryRow(ctx, updateOrganizationAgentQuota, arg.ID, arg.MaxAgentIdentities)
	var i Organization
	err := row.Scan(
		&i.ID,
		&i.Name,
